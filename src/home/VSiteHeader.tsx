...
export class VSiteHeader extends View<CHome> {
    render() {
        ...
        let right = undefined; // d-block d-md-none
        // let right = <img src={扫一扫} alt="" className="mr-2" style={{ width: 24 }} onClick={this.controller.openScanCode} />;
        /*
        ...
        return <LMR
            ...
            <div className="px-3 py-4">
                ...
                <img src={扫一扫} alt="" className="mr-2 mt-2" style={{ width: 30 }} onClick={this.controller.openScanCode} />
            </div>
        </LMR>
