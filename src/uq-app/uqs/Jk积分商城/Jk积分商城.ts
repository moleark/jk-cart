...
export interface DxExchagneMainState {
	id: number;
	state?: any;
	createDate?: any;
	$act?: number;
...
export interface ActParamDxExchagneMainState {
	id: number|IDXValue;
	state?: any|IDXValue;
...
export interface ParamActs {
	...
	dxExchagneMainState?: ActParamDxExchagneMainState[];
}
