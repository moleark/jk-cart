...
export interface TuidOrderMain {
	id?: number;
}

export interface TuidOrderDetail {
	id?: number;
}
...
export interface ParamPointBookByOrderDetail {
}
export interface ReturnPointBookByOrderDetail$page {
...
export interface ResultPointBookByOrderDetail {
	$page: ReturnPointBookByOrderDetail$page[];
}
...
export interface ParamPointHistoryByOrderDetail {
	orderDetailId: number;
	pointYear: number;
	point: number;
	type: number;
...
export interface ReturnPointHistoryByOrderDetail$page {
	date: any;
	orderDetailId: number;
	pointYear: number;
	point: number;
...
export interface ResultPointHistoryByOrderDetail {
	$page: ReturnPointHistoryByOrderDetail$page[];
}
...
export interface UqExt extends Uq {
	...
	OrderMain: UqTuid<TuidOrderMain>;
	OrderDetail: UqTuid<TuidOrderDetail>;
	...
	PointBookByOrderDetail: UqBook<ParamPointBookByOrderDetail, ResultPointBookByOrderDetail>;
	...
	PointHistoryByOrderDetail: UqHistory<ParamPointHistoryByOrderDetail, ResultPointHistoryByOrderDetail>;
